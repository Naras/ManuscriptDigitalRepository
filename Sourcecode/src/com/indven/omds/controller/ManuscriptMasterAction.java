...
public class ManuscriptMasterAction extends BaseAction {
    ...
    private List<PathaVO> pathaVOs = new ArrayList<>();
    private List<ConditionOfManuscriptVO> conditionOfManuscriptVOS = new ArrayList<>();
    ...
    private List<SpecificCategoryVO> articleSpecificCategoryVOs = new ArrayList<>();

    private List<String> illustrationsTypeList = new ArrayList<String>();
    private List<String> editedTypeList = new ArrayList<String>();
    private List<String> inkPigmentList = new ArrayList<String>();

    private List<Subject1VO> subject1VOS = new ArrayList<>();


    private Map<Integer, String> manuscriptWorkTypes1 = new HashMap<Integer, String>() {{
        put(1, "Archaeology");
        put(2, "Art history");
        put(3, "Auxiliary sciences of history");
        put(4, "Big History");
        put(5, "Chronology");
        put(6, "Classical studies");
        put(7, "Colonialism");
        put(8, "Comparative historical research");
        put(9, "Contemporary history");
        put(10, "Cultural history");
        put(11, "Demographic history");
        put(12, "Economic history");
        put(13, "Environmental history");
        put(14, "Historicity");
        put(15, "History of ideas");
        put(16, "Legal history");
        put(17, "Linguistic history");
        put(18, "Maritime history");
        put(19, "Medieval studies");
        put(20, "Military history");
        put(21, "Music history");
        put(22, "Nationalism studies");
        put(23, "Oral history");
        put(24, "Political history");
        put(25, "Social history");
        put(26, "Women’s history");
        put(27, "World history");

    }};

    public Map<Integer, String> getManuscriptWorkTypes1() {
        return manuscriptWorkTypes1;
    }

    public void setManuscriptWorkTypes1(Map<Integer, String> manuscriptWorkTypes1) {
        this.manuscriptWorkTypes1 = manuscriptWorkTypes1;
    }

    public List<SpecificCategoryVO> getArticleSpecificCategoryVOs() {
        return articleSpecificCategoryVOs;
    }

    public void setArticleSpecificCategoryVOs(
            List<SpecificCategoryVO> articleSpecificCategoryVOs) {
        this.articleSpecificCategoryVOs = articleSpecificCategoryVOs;
    }
    ...
    private static Boolean isArticlesRequired = false;

    private static Boolean isSubect1Required = false;

    private List<DigitalManuscriptVO> digitalManuscriptVOs;

    private List<AuthorVO> authorList = new ArrayList<>();
    ...
    /**
     * @param translatedDocumentVO the translatedDocumentVO to set
     */
    ...
    /**
     * @param presentReviewer2 the presentReviewer2 to set
     */
    ...
    /**
     * @param currentProcessDetailsId the currentProcessDetailsId to set
     */
    ...
    /**
     * @param currentProcessMasterFKId the currentProcessMasterFKId to set
     */
    ...
    /**
     * @param listForPagingCombo the listForPagingCombo to set
     */
    ...
    public String saveOrUpdateManuscript() {
        logger.debug("SaveOrUpdateManuscript()");
        String status = ERROR;
...
//            logger.debug("SaveOrUpdateManuscript().getSubject1:" + digitalManuscriptVO.getSubject1Ids());
		...
		Long userId = userInfoVO.getReferenceFkId();
                digitalManuscriptVO.setDigitizerId(userId);
                logger.debug("SaveOrUpdateManuscript() new manuscript\n" + digitalManuscriptVO);
                digitalManuscriptVO = manuscriptMasterServiceImpl
                        .saveDigitalManuscript(digitalManuscriptVO, publicationVO, getRequest().getServletContext().getRealPath(IndvenApplicationConstants.IMAGE_FOLDER_DIR));
            ...
            if (!isUpdating) {
                ...
                digitalManuscriptVO = manuscriptMasterServiceImpl.findManuscriptById(digitalManuscriptVO.getId(), getRequest().getServletContext().getRealPath(IndvenApplicationConstants.IMAGE_FOLDER_DIR));
                logger.debug("SaveOrUpdateManuscript() update manuscript \n" + digitalManuscriptVO);
            }
            ...
            logger.debug("saveOrUpdateManuscript() generateLists()");
            generateLists();
        }
    ...
    public String saveOrUpdateDigitalDocument() {
        logger.debug("saveOrUpdateDigitalDocument() ");
        String status = ERROR;
                    ...
                    digitalManuscriptVO = manuscriptMasterServiceImpl
                            .findManuscriptById(
                                    ...
                                    getRequest()
                                            ...
                                            .getRealPath(
                                                    IndvenApplicationConstants.IMAGE_FOLDER_DIR));
                    //authorList = digitalManuscriptVO.getAuthors();
...
//                    logger.debug("findbyid().getManuscriptById========= " + digitalManuscriptVO.getSubject1());
                } else {
    ...
    public String deriveDocumentsForManuscript() {
        ...
        try {
            String id = getRequest().getParameter("id");
//            logger.debug("deriveDocumentsForManuscript(): id " + id);
            if (id != null) {
                /* Loading document for overall manuscript */
                digitalManuscriptVO = manuscriptMasterServiceImpl
                        .findManuscriptById(
                ...
                digitalDocumentVO = manuscriptMasterServiceImpl
                        .findDocumentByManuscriptId(Long.parseLong(id));
                logger.debug("deriveDocumentsForManuscript().digitalDocumentVO "+digitalDocumentVO);
            } else {
                throw new OMDPCoreException(
                        OMDPCoreException.UNABLE_TO_FIND_MANUSCRIPT_DETAILS);
            }
    ...
    public String saveReSortingOrder() {
        String status = ERROR;
        ManuscriptMasterServiceImpl manuscriptMasterServiceImpl = new ManuscriptMasterServiceImpl();
//        logger.debug("saveResortingOrder().stage 1--------------- " + getRequest().getParameter("sortedArray"));
...
//			status = SUCCESS;
    ...
    public String searchForManuscript() {
        logger.debug("searchForManuscript() searchType:" + searchType);
        String status = ERROR;
    ...
    public String generateLists() {
        ...
        try {
            ...
            authorList = manuscriptMasterServiceImpl.findAllAuthor();

            SpecificCategoryVO vo1 = new SpecificCategoryVO();
            vo1.setId(new Long(1001));
            vo1.setName("Trans-disciplinary");

            SpecificCategoryVO vo2 = new SpecificCategoryVO();
            vo2.setId(new Long(1002));
            vo2.setName("Multi-Disciplinary");

            SpecificCategoryVO vo3 = new SpecificCategoryVO();
            vo3.setId(new Long(1003));
            vo3.setName("Single system of thought / philosophy");

            articleSpecificCategoryVOs.add(vo1);
            articleSpecificCategoryVOs.add(vo2);
            articleSpecificCategoryVOs.add(vo3);
            ...
            documentTypes.add(new LabelValueVO("Article", "3"));

            pathaVOs = manuscriptMasterServiceImpl.findAllPathas();
            subject1VOS = manuscriptMasterServiceImpl.findAllSubject1();
            conditionOfManuscriptVOS = manuscriptMasterServiceImpl.findAllConditionOfManuscripts();
            //logger.debug(" conditionOfManuscriptVOS "+conditionOfManuscriptVOS.size());
    ...
    public String findAllDigitisers() {
		...
		Map<String, Object> sessionX = ActionContext.getContext().getSession();
		UserInfoVO userInfoVO = (UserInfoVO) sessionX.get(IndvenApplicationConstants.LOGGEDIN_USER_SESSION_DATA);
		String userEmail = userInfoVO.getLoginName();
...
//                    .findAllDigitisersForTerm(requestTerm);
                    .findAllDigitisersForTerm(userEmail);
    ...
    public String findAllManuscripts() {
        logger.debug("findAllManuscripts()");
        String status = ERROR;
        ManuscriptMasterServiceImpl manuscriptMasterServiceImpl = new ManuscriptMasterServiceImpl();
        ...
        try {
            ...
            if (manuscriptVOs != null && manuscriptVOs.size() > 0) {
                logger.debug("findAllManuscripts() no.of manscripts:" + manuscriptVOs.size());
    ...
    public String findNoOfManuscripts() {
        logger.debug("findNoOfManuscripts()");
        String status = ERROR;
        ManuscriptMasterServiceImpl manuscriptMasterServiceImpl = new ManuscriptMasterServiceImpl();
        ...
        try {
            ...
            if (userInfoVO != null) logger.debug("findNoOfManuscripts\nuserInfoVo:" + userInfoVO);
            if (userInfoVO != null && (userInfoVO.getRoleMasterFkId().compareTo(IndvenApplicationConstants.ADMIN_ID) == 0
                    || userInfoVO.getRoleMasterFkId().compareTo(IndvenApplicationConstants.GUEST_ID) == 0
                    || userInfoVO.getRoleMasterFkId().compareTo(IndvenApplicationConstants.SCHOLAR_ROLE_ID) == 0)
                    ) {
    ...
    public String saveTempPhoto() {
         ...
         */
        logger.debug("================== ");
        String targetPath1= getRequest().getServletContext()
                .getRealPath(
                        IndvenApplicationConstants.IMAGE_FOLDER_DIR );
        logger.debug("saveTempPhoto() targetPath1 "+targetPath1);
        ...
        try {
            ...
            logger.debug("saveTempPhoto() photoNames "+photoNames);
            for (int i=0;i<photoNames.length;i++) {
                logger.debug("====== "+photoNames[i]);
            }
            logger.debug("saveTempPhoto() photoNames "+photoNames);
         ...
         /*   Map<String, Object> session = ActionContext.getContext().getSession();
            ...
            for (File i : photo) {
                ...
                String imageName = photoNames[count].trim();
                logger.debug("saveTempPhoto() imageName "+imageName);
                if (!(imageName.contains("Thumbs.db"))) {
                    String convertedImgName = CustomBeanUtil
                            .formatImageName(imageName);
                    String tempImage = userId.toString() + String.valueOf(currentTimeStamp) + convertedImgName.split("\\.")[0].replaceAll("\\s", "")
                            + "." + convertedImgName.split("\\.")[1];
                    String targetPath = getRequest().getServletContext()
                            .getRealPath(IndvenApplicationConstants.IMAGE_FOLDER_DIR + tempImage);
                    logger.debug("saveTempPhoto() targetPath "+targetPath);
                    ...
                    if (!ispdf) {
                        ...
                        logger.debug("saveTempPhoto() count===in image========= "+count);
                        imageContainer.put(count, targetPath);

                        count++;
                    }
                    logger.debug("saveTempPhoto() imageContainer "+imageContainer);


                    if (ispdf && !targetPath.contains(".tmp")) {

                        targetPath = targetPath.replace("\\", "/").trim();
                        if (!targetPath.endsWith(".pdf")) targetPath = targetPath + ".pdf";
                        logger.debug("saveTempPhoto() count============ "+count);
                        imageContainer.put(count, targetPath);
                        count++;
                    }
                    logger.debug("saveTempPhoto() imageContainer1 "+imageContainer);
                }
            }
            logger.debug("-----------------");
            ...
            //logger.debug("count is "+count+" height "+height+" width "+width);


            //By Lakshmi Prasad - Fix for if page size is 0
            if (count != 0) {
            ...
            logger.debug("saveTempPhoto() ======Put data into JSON object======== "+imageContainer);
            ...
            jsonObject.put("msg", "Successfully uploaded images");
            jsonObject.put("status", "success");
            status = SUCCESS;
//            logger.debug("saveTempPhoto() ======Status=Success======== ");
        } catch (OMDPCoreException e) {
            logger.error(e);
            jsonObject.put("msg", "Unable to upload due to some issue in pdf file");
            jsonObject.put("status", "failure");
            e.printStackTrace();
        } catch (IOException e) {
            logger.error(e);
            jsonObject.put("msg", "Unable to upload file");
            jsonObject.put("status", "failure");
            e.printStackTrace();
        } catch (Exception e) {
            logger.error(e);
    ...
    private void pdfProcessing(boolean isPdf,Long userId, String targetPath, Date createdDate,
                               Date modifiedDate, Map<Date, Integer> createdDateCounter, int count,
                               Map<Date, Integer> modifiedDateCounter, String lensMake, String lensModel, Map<String, Integer> lensMakeCounter,
                               Map<String, Integer> lensModelCounter,Long xResolution,Long yResolution,
                               Long height,Long width, JSONObject imageContainer) {
        try {
            if (isPdf) {
                final ExecutorService executor = Executors.newFixedThreadPool(15);
                String tempPath = getRequest().getServletContext()
                        .getRealPath(
                                IndvenApplicationConstants.IMAGE_FOLDER_DIR);
                logger.debug("tempPath " + tempPath);
                final String newImageName = userId.toString() + String.valueOf(System.currentTimeMillis()) + "_abc-";
                String pdfappPath = (ResourceBundle.getBundle(
                        "ApplicationResources", IndvenApplicationConstants.LOCALE)
                        .getObject("pdfapp.jarfile.path").toString()).trim();
                logger.debug("pdfappPath " + pdfappPath);
                String noOfImages = (ResourceBundle.getBundle(
                        "ApplicationResources", IndvenApplicationConstants.LOCALE)
                        .getObject("image.extraction.number").toString()).trim();
                boolean isConverted = false;
                convertPDFTOImages(new File(targetPath), newImageName, executor, tempPath);
                //List<CompletableFuture<Future>> futures = convertPDFTOImages1(new File(targetPath) , newImageName, executor, tempPath);
                ...
                File[] files = new File(tempPath).listFiles(new FilenameFilter() {
                    public boolean accept(File dir, String name) {
                        ...
                        if (lowercaseName.contains(newImageName)) {
                            return true;
                        } else {
                            return false;
                        }
                ...
                for (File imgFile : files) {
                    logger.debug("========stag1in file= " + imgFile.getAbsolutePath());
                    if (imgFile.exists()) {
                        logger.debug("========stag1i2 = ");
                        String imgGetName = imgFile.getName().split("\\.")[0];
                        imgGetName = imgGetName.split("abc-_")[1];

                        targetPath = imgFile.getPath();
                        ...
                        targetPath = targetPath.replace("\\", "/");
                        // Put the temp path of the image in JSON object
                        imageContainer.put(imgGetName, targetPath);
    ...
    private List<CompletableFuture<Future>> convertPDFTOImages1( File pdfFile, String imageName,ExecutorService executor, String tempPath) {
        List<CompletableFuture<Future>> futures = new ArrayList<>();
        PDDocument doc = null;
        try {
            ...
            //CompletableFuture[] futures = new CompletableFuture[ doc.getNumberOfPages()];
            //final List<Future<?>> futures = new ArrayList<>();
            for (int i = 0; i < doc.getNumberOfPages(); i++) {
                CompletableFuture future = CompletableFuture.runAsync(() -> {
                    //Future<?> future = executor.submit(() -> {
                    logger.debug("============== 1");
                    File fileTemp = new File(tempPath+"/"+imageName + "_" + index[0]+ ".jpg");
                    logger.debug("fileTemp "+fileTemp.getAbsolutePath());
                    BufferedImage image = null;
                    try {
                        image = renderer.renderImageWithDPI(index[0], 200);
            ...
            logger.debug("CONVERTER STOPTED.....");
        } catch (IOException e) {
            e.printStackTrace();
        }
        return futures;
    ...
    private void convertPDFTOImages( File pdfFile, String imageName,ExecutorService executor, String tempPath) {
        PDDocument doc = null;
        try {
            doc = PDDocument.load(pdfFile);
            ...
            logger.debug(" datecend "+ DateTime.now());
    ...
    /**
     * @param manuscriptConditionTypes the manuscriptConditionTypes to set
     */
    ...
    /**
     * @param manuscriptDocumentationTypes the manuscriptDocumentationTypes to set
     */
    ...
    /**
     * @param sourceOfCatagoryTypes the sourceOfCatagoryTypes to set
     */
    ...
    /**
     * @param manuscriptWorkTypes the manuscriptWorkTypes to set
     */
    ...
    public List<PathaVO> getPathaVOs() {
        return pathaVOs;
    }

    public void setPathaVOs(List<PathaVO> pathaVOs) {
        this.pathaVOs = pathaVOs;
    }

    public List<ConditionOfManuscriptVO> getConditionOfManuscriptVOS() {
        return conditionOfManuscriptVOS;
    }

    public void setConditionOfManuscriptVOS(List<ConditionOfManuscriptVO> conditionOfManuscriptVOS) {
        this.conditionOfManuscriptVOS = conditionOfManuscriptVOS;
    }
    ...
    /**
     * @param bundleMasterVOs the bundleMasterVOs to set
     */
    ...
    public List<String> getIllustrationsTypeList() {
        illustrationsTypeList.add("Chitra Pristhika");
        illustrationsTypeList.add("Illustrations in Margin");
        illustrationsTypeList.add("Illustrations on Page Digits");
        illustrationsTypeList.add("Yantra");
        illustrationsTypeList.add("Madhya Fullika");
        illustrationsTypeList.add("Madhya Fullika Chitra");
        illustrationsTypeList.add("Square on Madhya Fullika");
        illustrationsTypeList.add("Other");
        return illustrationsTypeList;
    }

    public List<String> getEditedTypeList() {
        editedTypeList.add("Padachcheda");
        editedTypeList.add("Vibhakti");
        return editedTypeList;
    }


    public List<String> getInkPigmentList() {
        inkPigmentList.add("Ochre (Geru)");
        inkPigmentList.add("Arsenic (Hartal)");
        inkPigmentList.add("White ink (Safedo)");
        inkPigmentList.add("Other");
        return inkPigmentList;
    }

    public static Boolean getIsArticlesRequired() {
        isArticlesRequired = Boolean.valueOf((ResourceBundle.getBundle("ApplicationResources", IndvenApplicationConstants.LOCALE)
                .getObject("config.isArticlesRequired").toString()).trim());
        return isArticlesRequired;
    }

    public static void setIsArticlesRequired(Boolean isArticlesRequired) {
        ManuscriptMasterAction.isArticlesRequired = isArticlesRequired;
    }

    public static Boolean getIsSubect1Required() {
        isSubect1Required = Boolean.valueOf((ResourceBundle.getBundle("ApplicationResources", IndvenApplicationConstants.LOCALE)
                .getObject("config.createnew.manuscript.subject1.required").toString()).trim());
//        logger.debug("getIsSibect1Required isSubect1Required() " + isSubect1Required);
        return isSubect1Required;
    }

    public static void setIsSubect1Required(Boolean isSubect1Required) {
        ManuscriptMasterAction.isSubect1Required = isSubect1Required;
    }

    public List<Subject1VO> getSubject1VOS() {
        return subject1VOS;
    }

    public void setSubject1VOS(List<Subject1VO> subject1VOS) {
        this.subject1VOS = subject1VOS;
    }
        
    public String toString() {
        return "ManuscriptVO:" + digitalManuscriptVO;
    }
}
