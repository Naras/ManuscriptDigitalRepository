...
text-align: center;
width: 230px;
z-index: 20;left:76%; border: 1px solid #404040;">
		      <s:label key="image2"></s:label>
		      </div>
		    </div>
...
z-index: 20;left:76%; border: 1px solid #404040;"> 
		...
		<div style="max-width:100%; border: 1px solid; background-color: #9d4a9c; font-weight: bold; font-family: 'Calisto MT', 'Bookman Old Style', Bookman,serif;" align="center">S A M S K R T I</div>
			<div>
				...
				A. High quality medical practices and research in  Indian  systems of medicine<br>
B. Conservation of the natural resources used by Indian systems of medicine<br>
