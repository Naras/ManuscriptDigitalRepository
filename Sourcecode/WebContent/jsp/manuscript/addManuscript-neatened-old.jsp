		...
		<div class="form">
			<div class="container" style="margin-top: -50px">
				...
				<s:form action="addUpdateManuscript" role="form" id="manuscriptForm"
					...
					<s:hidden id="isPrintedValue" name="digitalManuscriptVO.articleDetailsVO.isPrinted" />
					...
					<s:hidden id="articleLanguage" name="digitalManuscriptVO.articleLaguage" />
					<div class="form-group row buttons container-center">
                                            ...
                                            <s:if test="isArticlesRequired">
                                                <div class="col-md-3">
                                                    <a href="#" id="articleContainer" class="main-tab btn btn-lg btn-primary btn-block">Article</a>
                                                </div>
                                            </s:if>
                                            <div class="col-md-1"></div>
                                            <div class="col-md-3">
					...
					<div class="form-container" id="tab-form">
                                            ...
                                            <h2 class="form-heading articleContainer" style="max-width: 60%;">Article Digitization</h2>
                                            <ul class="nav nav-tabs" style="max-width: 100%; padding: 0px;">
                                                <li class="active"><a href="#manuscript" data-toggle="tab">Basic Info.</a></li>
                                                <li class="manuscript-specific"><a href="#author" data-toggle="tab">Author Info./Scribe Info.</a></li>
                                                <li class="bookContainer"><a href="#author" data-toggle="tab">Author Info.</a></li>
                                                <li class="articleContainer"><a href="#author" data-toggle="tab">Author Info.</a></li>
                                                <li><a href="#frame" data-toggle="tab">Images</a></li>
                                                <li class="manuscript-specific"><a href="#nmm" data-toggle="tab">NMM</a></li>
                                                <li><a href="#publication" data-toggle="tab">Additional Info.</a></li>
                                            </ul>

                                            <div class="tab-content">
                                                <div class="tab-pane fade active in container-center" id="manuscript" style="max-width: 100%;"><br>
                                                <div class="form-group row" style="margin-bottom: 2px;">
                                                    <label class="col-md-2 control-label manuscript-specific">Manuscript ID</label>
                                                    <label class="col-md-2 control-label bookContainer">Book ID</label>
                                                    <label class="col-md-2 control-label articleContainer">Article ID</label>
                                                    <div class="col-md-4">
                                                        <s:textfield cssClass="form-control" id="manuscriptIdentification" name="digitalManuscriptVO.manuscriptId" maxlength="100" />
                                                    </div>
                                                    <label class="col-md-2 control-label manuscript-specific">Manuscript Name</label>
                                                    <label class="col-md-2 control-label bookContainer">Book Name</label>
                                                    <label class="col-md-2 control-label articleContainer">Article Name</label>
                                                    <div class="col-md-4">
                                                        <s:textfield cssClass="form-control" id="manuscriptName" name="digitalManuscriptVO.name" maxlength="250" />
                                                    </div>
                                                </div>
                                                <div class="form-group row manuscript-specific" style="margin-bottom: 2px;">
                                                ...
                                                <div class="form-group row" id="otherLanguageNameField" style="margin-bottom: 2px;">
                                                     <div class="col-md-2" style="padding-right: 0px;">
                                                         <label class="control-label">Name(in Diacritical) <!-- <span class="glyphicon glyphicon-info-sign" style="color: red;" data-toggle="popover" data-content="Diacritical Name"></span> -->
                                                         </label>
                                                     </div>
                                                     <div class="col-md-4">
                                                         <s:textfield cssClass="form-control"
                                                                 id="manuscriptDiacriticName"
                                                                 name="digitalManuscriptVO.diacriticName" maxlength="250" placeholder="Multilingual field.." />
                                                     </div>
                                                     <div class="col-md-2" style="padding-right: 0px;">
                                                         <label class="control-label">Name(in Vernacular) <!--  <span class="glyphicon glyphicon-info-sign" style="color: red;" data-toggle="popover" data-content="Regional Name"></span> -->
                                                         </label>
                                                     </div>
                                                     <div class="col-md-4">
                                                         <s:textfield cssClass="form-control"
                                                                 id="manuscriptRegionalName"
                                                                 name="digitalManuscriptVO.regionalName" maxlength="250" placeholder="Multilingual field.." />
                                                     </div>
                                                     </div>
                                                    <fieldset>
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group row articleContainer"
                                                                style="margin-bottom: 0px;">
                                                                <label class="col-md-4 control-label">To Philosophy/respective field of thought </label>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-md-12">
                                                        ...
                                                        <div class="form-group row articleContainer"
                                                                style="margin-bottom: 0px;">
                                                                <label class="col-md-4 control-label">Names of fields covered</label>
                                                        </div>
                                                        <div class="form-group row articleContainer">
                                                            <div class="col-md-12">
                                                                <s:textarea cssClass="form-control" name="digitalManuscriptVO.fieldsCovered" maxlength="3500" />
                                                            </div>
                                                        </div>
                                                        <div class="form-group row" style="margin-bottom: 0px;">
                                                    ...
                                                    <fieldset class="articleContainer">
                                                        ...
                                                        <div class="form-group row is-published-oth articleContainer">
                                                            ...
                                                            <div class="col-md-8 btn-group articleContainer" data-toggle="buttons">
                                                                <label class="col-xs-4 btn btn-primary"
                                                                        id="isOtherPublished1Container"> <input type="radio"
                                                                        id="isJournal" value="1">Online Journal/Publication</label>
                                                                <label class="col-xs-4 btn btn-primary"
                                                                            id="isOtherPublished2Container"> <input type="radio"
                                                                            id="isMagazineOthers" value="0">Journal/Magazine/Others</label>
                                                                <s:hidden name="digitalManuscriptVO.articleDetailsVO.type" id="articleDetailsType"></s:hidden>
                                                                <s:hidden name="digitalManuscriptVO.articleDetailsVO.id"></s:hidden>
                                                            </div>
                                                        </div>
                                                        <div class="ifMagazine">
                                                            <div class="form-group row">
                                                                <label class="col-md-2 control-label">Name of the Journal/Magazine/Any other type:</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.nameOfMagazine" />
                                                                </div>
                                                                <label class="col-md-2 control-label">ISSN No</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.magazineIssnNo" id="issnNo" maxlength="50" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-md-2 control-label">Name of the editor</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.nameOfEditor" id="artnameOfEditor" />
                                                                </div>
                                                                <label class="col-md-2 control-label">Year of Publication</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.yearOfPublication" id="yearOfPublication" maxlength="4" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-md-2 control-label">Abstract of the Article</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.abstractOfMagazine" id="abstractOfArticle" />
                                                                </div>
                                                                <label class="col-md-2 control-label">Address</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.address" id="magazineAddress" maxlength="1000" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-md-2 control-label">Number of Pages</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.noOfPages" id="noOfPages" maxlength="10" />
                                                                </div>
                                                                <label class="col-md-2 control-label">Price(INR)</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.price" id="magazineprice" maxlength="100" />
                                                                </div>
                                                            </div>
                                                        <!-- <div class="form-group row">
                                                            ...
                                                            <div class="col-md-8 btn-group" data-toggle="buttons">
                                                                <label class="col-xs-4 btn btn-primary" id="isAvailable1Container">
                                                                        <input type="radio" id="isAvailable1" value="1">Yes</label>
                                                                <label class="col-xs-4 btn btn-primary" id="isAvailable2Container">
                                                                        <input type="radio" id="isAvailable2" value="0">No</label>
                                                                <label class="col-xs-4 btn btn-primary" id="isAvailable3Container">
                                                                        <input type="radio" id="isAvailable3" value="2">Unknown</label>
                                                            </div>
                                                        </div> -->
                                                        </div>
                                                        <div class="Otherpublished">
                                                            <div class="form-group row">
                                                                <label class="col-md-2 control-label">Website where it is published</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.website" id="websiteName" maxlength="50" />
                                                                </div>
                                                                <label class="col-md-2 control-label">ISSN No</label>
                                                                <div class="col-md-4">
                                                                    <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.issnNo" id="publicationIssnNo" maxlength="50" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                    <label class="col-md-2 control-label">Other details about the Journal</label>
                                                                    <div class="col-md-4">
                                                                        <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.journalOthrDtls" id="journalOthDtls" />
                                                                    </div>
                                                                    <label class="col-md-2 control-label">Abstract of the Article</label>
                                                                    <div class="col-md-4">
                                                                        <s:textfield cssClass="form-control" name="digitalManuscriptVO.articleDetailsVO.abstractOfArticle" id="AbstractOfArticle" maxlength="500" />
                                                                    </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row" id="isPrinted">
                                                            ...
                                                            <div class="col-md-8 btn-group" data-toggle="buttons">
                                                                <label class="col-xs-4 btn btn-primary"
                                                                        ...
                                                                        id="isPrinted1" value="1">Yes</label>
                                                                <label class="col-xs-4 btn btn-primary"
                                                                        id="isPrinted2Container"> <input type="radio"
                                                                        id="isPrinted2" value="0">No</label>
                                                                <label class="col-xs-4 btn btn-primary"
                                                                        id="isPrinted3Container"> <input type="radio"
                                                                        id="isPrinted3" value="2">Unknown</label>
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                ...
                                                <div class="tab-pane fade container-center" id="author" style="max-width: 100%;"><br> <br>
                                                    <fieldset>
                                                        ...
                                                        <div id="authorBox">
                                                            ...
                                                            <s:iterator value="digitalManuscriptVO.authors" status="var">
                                                                ...
                                                                <div class='containerAuth author-data' style='border: thin solid #404040;' id="authorDivId<%=i%>"><br>
                                                                    <div class='form-group row'>
                                                                        <label class='col-md-4 control-label'>Name</label>
                                                                        <div class='col-md-8'>
                                                                            <s:textfield type='text' cssClass='form-control' id='authorName%{#var.index}'
                                                                                    name='digitalManuscriptVO.authors[%{#var.index}].name' maxlength='255' />
                                                                            <s:hidden id='authorId%{#var.index}' name='digitalManuscriptVO.authors[%{#var.index}].id' />
                                                                        </div>
                                                                    </div>
                                                                    <div class='form-group row'>
                                                                        <label class='col-md-4 control-label'>Name (in Diacritical)</label>
                                                                        <div class='col-md-8'>
                                                                            <s:textfield type='text' cssClass='form-control' id='authorDiacriticName%{#var.index}'
                                                                                    name='digitalManuscriptVO.authors[%{#var.index}].diacriticName' maxlength='250' placeholder='Multilingual field..' />
                                                                        </div>
                                                                    </div>
                                                                    <div class='form-group row'>
                                                                        <label class='col-md-4 control-label'>Name(in Vernacular)</label>
                                                                        <div class='col-md-8'>
                                                                            <s:textfield type='text' cssClass='form-control' id='authorRegionalName%{#var.index}'
                                                                                name='digitalManuscriptVO.authors[%{#var.index}].regionalName' maxlength='250' placeholder='Multilingual field..' />
                                                                        </div>
                                                                        </div>
                                                                        <div class='form-group row'>
                                                                            <div class='col-md-12'>
                                                                        ...
                                                                        <div class='form-group row'>
                                                                            ...
                                                                            <div class='col-md-6'>
                                                                                <s:textfield type='text' cssClass='form-control' id='authorPeriod%{#var.index}'
                                                                                        name='digitalManuscriptVO.authors[%{#var.index}].period' maxlength='100' />
                                                                            </div>
                                                                            <div class='col-md-2'>
                                    ...
                                    <div class="commentator-container">
                                        ...
                                        <div class="translator-container">
                                            <fieldset>
                                                ...
                                                <div class="tab-pane fade container-center" id="frame" style="max-width: 100%;"><br>
                                                    <div class="form-group row">
                                                        <div class="col-md-12">
                                                            <div class="alert alert-warning validation-warning" style="border-color: #d88a25;">
                                                    ...
                                                    <div class="form-group row"
                                                            ...
                                                            <div class="col-md-12 alert alert-success"
                                                                    style="background-color: #EEE; border-color: #404040;">
                                                                <div class=" col-md-4">
                                                                    <label class="control-label" style="padding-top: 15px;">Upload File</label> <span class="glyphicon glyphicon-info-sign labelInfo"
                                                                        style="color: red;" data-toggle="popover"
                                                                ...
                                                                <div class="col-xs-8 col-md-2">
                                                                    <span class="btn btn-default btn-file" style="border-color: #404040;"> <span>Browse</span> <input
                                                    ...
                                                    <div class="form-group row" style="display: none; padding: 15px;" id="thumbnaildisplay">
                                                        <div style="max-height: 32em; border: 1px solid #404040;">
                                                            <div id="selectbutton-pannel">
                                                                <input type="button" id="selectbtn" class="selectbutton btn-primary" value="Select"
                                                                    onclick="selectedIteam()"> <input type="checkbox" name="imgselect" id="selectframe" style="display: none;">
                                                                <input type="checkbox" name="allimgselect" id="selectall"
                                                                    onclick="selectAll();">Select All<span id="frameCount" style="margin-left: 10px; font-weight: bold;"></span>
                                                                <input type="button" class="selectbutton btn-danger" id="delimg"
                                                                    value="Delete" style="display: none; float: right;" onclick="deleteImage();">
                                                            </div>
                                                            <div class="panel-body" style="max-height: 25em; overflow-y: scroll; border-top: 1px solid #404040;">
                                                                <!-- <div class="imageContainer" id="imageContainer"> </div> -->
                                                            </div>
                                                            </div>
                                                    </div>
                                                    <div class="form-group row buttons container-center" style="margin-top: 100px;" id="frameButton">
                                                        <div class="col-md-4">
                                                ...
                                                <div class="tab-pane fade container-center" id="nmm" style="max-width: 100%;"><br>
                                                    <div class="panel-group" id="accordion">
                                                        <div id="accordionPanelHeader" class="panel panel-default appTable">
                                                            ...
                                                            <div id="collapseOne" class="panel-collapse collapse in" style="padding: 5px;">
                                                                <div class="form-group row">
                                                                    <label class="col-md-2 control-label">Nature Of Collection</label>
                                                                    <div class="col-md-4 btn-group" data-toggle="buttons">
                                                                        <label class="col-xs-6 btn btn-primary" id="natureOfCollection1Container"> <input type="radio" id="natureOfCollection1" value="1">Personal</label>
                                                                        <label class="col-xs-6 btn btn-primary" id="natureOfCollection2Container"> <input type="radio" id="natureOfCollection2" value="0">Institutional</label>
                                                                    </div>
                                                                    <label class="col-md-2 control-label">Bound</label>
                                                                    <div class="col-md-4 btn-group" data-toggle="buttons">
                                                                        <label class="col-xs-6 btn btn-primary" id="isBound1Container"> <input type="radio" id="isBound1" value="1">Yes</label>
                                                                        <label class="col-xs-6 btn btn-primary" id="isBound2Container"> <input type="radio" id="isBound2" value="0">No</label>
                                                                    </div>
                                                                </div>
                                                                                    <!-- <div class="form-group row">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                            <label class="col-md-2 control-label">Source Of Catalogue</label>
                                                                                            <div class="col-md-4">
                                                                                            ...
                                                                                            <label class="col-md-2 control-label">Catalogue Number</label>
                                                                                            <div class="col-md-4">
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        <label class="col-md-2 control-label">Catalogue Details</label>
                                                                                        <div class="col-md-4">
                              ...
                              <s:select list="manuscriptDocumentationTypes" cssClass="form-control"
                                          name="digitalManuscriptVO.documentationOfManuscript" autoComplete="false" maxlength="50"/>
                                                                                    ...
                                                                                    <div class="form-group row">
                                                                                        ...
                                                                                        <div class="col-md-4">
                                                                                            <s:textfield cssClass="form-control" id="colophon" name="digitalManuscriptVO.colophon" placeholder="Multilingual field.." maxlength="1000" />
                                                                                        </div>
                                                                                        <label class="col-md-2 control-label">Number Of Illustrations</label>
                                                                                        <div class="col-md-4">
                                              ...
                                              <div class="col-md-8">
                                                  <s:textfield cssClass="form-control" id="endingLine" name="digitalManuscriptVO.endingLine" placeholder="Multilingual field.." maxlength="250"/>
                                                                    ...
                                                                    <div class="panel panel-default appTable" id="accordionPanelHeader1">
                                                                        <div class="panel-heading" data-toggle="collapse" data-parent="#accordion" data-target="#collapseTwo" style="background: #eee;">Technical Details</div>
                                                                        <div id="collapseTwo" class="panel-collapse collapse" style="padding: 5px;">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <label class="col-md-2 control-label" style="padding-right: 0px;">Average Image Width</label>
                                                                                <div class="col-md-4">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label class="col-md-2 control-label" style="padding-right: 0px;">Median Created Date</label>
                                                                                <div class="col-md-4">
                                                                                    <s:textfield cssClass="form-control" id="imageCreatedDate" name="digitalManuscriptVO.nmmDetailsVO.createdDate" maxlength="50" />
                                                                                </div>
                                                                                <label class="col-md-2 control-label" style="padding-right: 0px;">Median Digitised Date</label>
                                                                                <div class="col-md-4">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <label class="col-md-2 control-label" style="padding-right: 0px;">X Resolution</label>
                                                                                <div class="col-md-4">
                                                                                    <s:textfield cssClass="form-control" id="imageXResolution" name="digitalManuscriptVO.nmmDetailsVO.xResolution" maxlength="50" />
                                                                                </div>
                                                                                <label class="col-md-2 control-label" style="padding-right: 0px;">Y Resolution</label>
                                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="panel panel-default appTable" id="accordionPanelHeader2">
                                                                        ...
                                                                        <div id="collapseThree" class="panel-collapse collapse" style="padding: 5px;">
                                                ...
                                                <div class="tab-pane fade container-center" id="publication" style="max-width: 100%;"><br>
                                                            <fieldset>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-8 btn-group" data-toggle="buttons">
                                                                            <label class="col-xs-4 btn btn-primary"
                                                                                    ...
                                                                                    id="isOrganisation1" value="1">Individual</label>
                                                                            <label class="col-xs-4 btn btn-primary"
                                                                                        id="isOrganisation2Container"> <input type="radio"
                                                                                        id="isOrganisation2" value="0">Institution</label>
                                                                        </div>
                                                                    </div>
                                                            </fieldset>
                                                            <fieldset>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/assets/js/addmanuscript.js"></script>
...
<script type="text/javascript">
	...
	$('.main-tab').click(function(e){
		/* Handler for opening respective div on new record : Book or Manuscript */
	...
	$(document).ready(function() {
		...
		if($('#authorId').val() > 0) {$('.author-data').show();}
		if($('#scribeId').val() > 0) {$('.scribe-data').show();}
		if($('#commentatorId').val() > 0) {$('.commentator-container').show();}
		if($('#subCommentatorId').val() > 0) {$('.subCommentator-container').show();}
		if($('#translatorId').val() > 0) {$('.translator-container').show();}	
		...
		if($('#nmmDetailsId').val() > 0) {$('.image-details').show();}
                    ...
                    for(var i = 0; i < Object.keys(fileDiskPathObject).length; i++) {
                        if(fileDiskPathObject[i].id != ""){
                            ...
                            if (filePath.lastIndexOf(".pdf")<=-1) {
                                ...
                                htmlString += "<div style='width:50px;heigth:50px;margin: 20px;'><a href='#' data-href='" + '<%=request.getContextPath()%>/pdfAction.action?path=' + filePath + '&id='+fileDiskPathObject[i].id+"' id='pdf_" + fileDiskPathObject[i].id + "' class='showModal' ><i class='fa fa-file-pdf-o' style='font-size:15rem;color:red;font-weight:normal;' aria-hidden='true'></i></a></div>";
                            }
                            countImage++;
                        }
                    }
	...
	$(function() {
              ...
              source: function (request, response) {
                    $.getJSON("findAllAuthors.action?term=" + request.term + "&requestId=" + requestId + "&type=1" , function (data) {
                        response($.map(data.authors, function (item) {
                            ...
                            } else if(item.diacriticName.toLowerCase().indexOf(request.term) != -1) {labelData = item.diacriticName;
                            } else {labelData = item.name;}
                            return {label: labelData, value: labelData, id : item.id};
                        }));
                    });
                },
	    ...
	    $('#editorName').autocomplete({
		    ...
		    select: function( event, ui ) {
	    		...
	    		$('#editorName').val(editorMap[ui.item.id].name); editorFlag = 1;},
		    minLength:1 
		 });
...
//	        url: "/mdr-src/uploadImagesToTemp.action",  //Server script to process data
	        ...
	        //	alert($('#filePathContainer').val());
	        	...
	        	if(!$('.image-details').hasClass('manuscript-specific')) {$('.image-details').fadeIn();}
	        },
	        error: function(data) {$('.loading-container').fadeOut();},
	        // Form data
	        data: formData,
	...
	} else{alert("Select a file for upload using the Browse button");}
	});
            ...
            var imgno=parseInt($("#currentImg").text());
             if(imgno < parseInt($("#totalImg").text()))
                    ...
                    ajaxCallForImage(fileDiskPathObject[imgno].filePathReal);
                     } else{alert("This Is The Last Image");} 
	});
	...
	$('#prevImg').click(function(){
		...
		var imgno=parseInt($("#currentImg").text());
	 	...
	 	} else{alert("This Is The First Image");} 
	});
	...
	$('input[type=button]').click(function(e) {
            if($(e.target).attr('id') == "tagbutton") {addTag();}
            e.preventDefault();
	});
    function addTag() {
...
$(document).on("click",".thumbnail-close", function(e) {
        ...
        //      $('.image-max-container img').attr('src', '/mdr-src'+ '/temp/' + data.realPath);
            $('.image-max-container img').attr('src', '<%=request.getContextPath()%>/temp/' + data.realPath);
                /*   $('#manuscriptForm').hide();
                  ...
                  error: function(data) {alert('Sorry No NMM Details Found');}
            });
        }
	...
	var listofParameters = $('.panel-body input:checkbox');
        alert('selecting all...loplength:'+listofParameters.length);
   ...
   // $('input[type="checkbox"]').css('display',''); 
	...
	if($('#selectframe').is(':checked')){
	var listofParameters = $('.panel-body input:checkbox');
        alert('selecting Item...loplength:'+listofParameters.length);
	for (var i=0;i<listofParameters.length;i++) {
		$(listofParameters[i]).prop("checked",false);
		//$(listofParameters[i]).css('display','none'); 
	}
    ...
    function deleteImage(){
        ...
        if(r == true) {alert('function deleteImage() length:'+listofParameters.length);
        for (var i=0;i<listofParameters.length;i++) {
        ...
        if(count>0){deleteFrame(frameIds);
        } else{alert("No Image Is Selected");}
       }	
      }
