...
<%@ include file='../layout/header.jsp' %>
	...
	<div class="form">
		<div style="margin-left: 3%;margin-right: 3%;">
			...
			<s:form action="saveSpecificCategory" name="frm" onsubmit="return validateForm();">
				<div class="form-group row">
					<label class="col-xs-4 control-label">Name</label>
					<div class="col-xs-8">
						<s:hidden name="specificCategoryVO.id"/>
						<s:textfield name="specificCategoryVO.name" id="Cname" required="true" maxlength="250" cssClass="form-control"/>
					</div>
				</div>
